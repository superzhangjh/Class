 ...
 */
package com.example.a731.aclass.zxing.activity;
...
import com.example.a731.aclass.zxing.utils.CaptureActivityHandler;
import com.example.a731.aclass.zxing.utils.InactivityTimer;
	...
	public void handleDecode(Result rawResult, Bundle bundle) {
		...
		switch (type){
			...
			case "https"://跳转到网页
				...
				break;
			default:
				Log.i("QRCodeResult",result);
				Toast.makeText(getApplicationContext(), "暂时不支持该类型二维码", Toast.LENGTH_SHORT).show();
				break;
		}
